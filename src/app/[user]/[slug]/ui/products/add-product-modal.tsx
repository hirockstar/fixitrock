...
export default function AddProductModal({ isOpen, onOpenChange }: AddProductModalProps) {
    const [{ errors }, dispatch, isLoading] = useActionState(addProduct, {
        errors: {},
    })
    ...
    return (
        ...
        >
            <ModalContent>
                ...
                <ModalBody className=''>
                    <Form action={handleFormAction} validationErrors={errors}>
                        {/* Product Details */}
