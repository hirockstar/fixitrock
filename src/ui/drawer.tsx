...
>(({ className, children, ...props }, ref) => (
    <DrawerPortal>
        ...
        <DrawerPrimitive.Content
            ref={ref}
            className='fixed inset-x-0 bottom-0 z-50 flex h-auto max-h-[70vh] flex-col rounded-t-3xl border bg-content1 focus:outline-none dark:bg-[#0a0a0a]' //max-h-[calc(100vh-10rem)]
            {...props}
        >
