...
export function Mdx(props: SVGProps<SVGSVGElement>) {
    return (
        ...
        >
            ...
            ></path>
            <path d='m272.696 40.203l-.002 84.896l31.185-31.178l15.74 15.741l-57.642 57.638l-58.369-58.369l15.741-15.741l31.085 31.085l.001-84.072zM72.162 162.979V97.232l40.255 40.257l40.56-40.557v65.383h22.261V43.192l-62.82 62.816l-62.517-62.521v119.492z'></path>
            <path
                fill='#f9ac00'
    ...
    return (
        ...
        >
            ...
            >
                ...
                <path d='M15 3.5A9 9 0 0 1 20.5 9H16a1 1 0 0 1-1-1z'></path>
            </g>
        </svg>
    )
}
    ...
    return (
        ...
        >
            <g
                ...
                color='currentColor'
            >
                <path d='M11.026 3a9.028 9.028 0 0 0 1.003 18A9.03 9.03 0 0 0 21 13'></path>
                <path d='m21 6.025l-1-.002c-3.737-.01-5.605-.015-6.918.93c-.437.313-.82.695-1.135 1.131C11 9.395 11 11.264 11 15m10-8.975a.7.7 0 0 0-.175-.472C20.06 4.647 18.071 3 18.071 3M21 6.025a.7.7 0 0 1-.174.422C20.06 7.353 18.07 9 18.07 9'></path>
            </g>
        </svg>
    )
}
    ...
    return (
        ...
        >
            <g
                ...
                color='currentColor'
            >
                <path d='M14.556 13.218a2.67 2.67 0 0 1-3.774-3.774l2.359-2.36a2.67 2.67 0 0 1 3.628-.135m-.325-3.167a2.669 2.669 0 1 1 3.774 3.774l-2.359 2.36a2.67 2.67 0 0 1-3.628.135'></path>
                <path d='M21 13c0 3.771 0 5.657-1.172 6.828S16.771 21 13 21h-2c-3.771 0-5.657 0-6.828-1.172S3 16.771 3 13v-2c0-3.771 0-5.657 1.172-6.828S7.229 3 11 3'></path>
            </g>
        </svg>
    )
}
