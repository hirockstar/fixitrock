        ...
        <>
            ...
            {isIframeLoaded && data && (
                <iframe
                    ...
                    src={`https://fixitrock-my.sharepoint.com/personal/space_fixitrock_com/_layouts/15/embed.aspx?UniqueId=${extractUniqueId(file['@microsoft.graph.downloadUrl'] || '')}&embed=%7B%22ust%22%3Atrue%2C%22hv%22%3A%22CopyEmbedCode%22%7D&referrer=StreamWebApp&referrerScenario=EmbedDialog.Create`}
                />
            )}
        </>
    )
